        ...
        public static void Register(HttpConfiguration httpConfig)
        {
            ...
            httpConfig
                .EnableSwagger(c =>
                {
                    ...
                    // additional fields.
                    //
                    c.SingleApiVersion("v1", "Swashbuckle Gongsibao WWW")
                        .Description("公司宝WWW项目的WebAPI文档")
...
//                        c.SchemaFilter<ApplySchemaVendorExtensions>();
                    ...
                    //  
                    c.SchemaId(
                        t => t.FullName.Contains('`') ? t.FullName.Replace('`','_') : t.FullName);
...
//                        c.CustomProvider((defaultProvider) => new CachingSwaggerProvider(defaultProvider));
        ...
        {
            var baseDirectory = AppDomain.CurrentDomain.SetupInformation.ApplicationBase+"Doc";
           
            return string.Format(@"{0}\Com.Gongsibao.Www.WebApi.xml", baseDirectory);
        }
        private static string GetDomainXmlCommentsPath()
        {
            var baseDirectory = AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "Doc";
            return string.Format(@"{0}\Com.Gongsibao.Www.Domain.XML", baseDirectory);
        }
